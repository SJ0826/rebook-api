...
export class ChatController {
  ...
  @ApiOperation({ summary: '채팅 메시지 조회', description: '특정 채팅방의 기존 메시지를 조회합니다.' })
   ...
   */
  @Get('unread-messages')
  @ApiOperation({ summary: '읽지 않은 메시지 개수 조회', description: '사용자가 읽지 않은 메시지의 개수를 조회합니다.' })
  ...
  @ApiOperation({ summary: '채팅 읽음 처리', description: '사용자가 채팅방을 읽었을 때 해당 채팅방의 \'lastReadAt\'을 업데이트합니다.' })
